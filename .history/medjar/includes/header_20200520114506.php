...
<html lang="pl">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top" id="navibar">
            <a class="navbar-brand " href="#"><alt src="" height="35" width="35" class="d-inline-block"></alt>
    ...
    <div id="carouselGallery" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/" height="600" width="1200" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <p><a role="button" class="btn btn-primary">NOCLEGI JAROSŁAWIEC</a></p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="images/" height="600" width="1200" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <p><a role="button" class="btn btn-primary">NOCLEGI JAROSŁAWIEC</a></p>
                </div>
            </div>
