...
<section id="sec1">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-8 col-lg-8 col-md-10 col-sm-10 col-12">
                <p class="text-center">Dla klientów Villi - 10% rabatu w Śląskiej Karczmie u Ola w centrum!</p>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-6">
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-sm-2 col-12">
				<img src="images/beach.png" class="rounded mx-auto d-block">
				<h3 class="text-center">Plaża w Jarosławcu</h3>
			</div>
			<div class="col-sm-2 col-12">
				<img src="images/cliff.png" class="rounded mx-auto d-block">
				<h3 class="text-center">Klifowe wybrzeże</h3>
			</div>
			<div class="col-sm-2 col-12">
				<img src="images/lighthouse.png" class="rounded mx-auto d-block">
				<h3 class="text-center">Latarnia Morska w Jarosławcu</h3>
			</div>
			<div class="col-sm-2 col-12">
				<img src="images/anchor.png" class="rounded mx-auto d-block">
				<h3 class="text-center">Przystań rybacka</h3>
			</div>
			<div class="col-sm-2 col-12">
				<img src="images/museum.png" class="rounded mx-auto d-block">
				<h3 class="text-center">Unikalne Muzeum Bursztynu</h3>
			</div>
			<div class="col-sm-2 col-12">
				<img src="images/rope.png" class="rounded mx-auto d-block">
				<h3 class="text-center">Park linowy dla dzieci</h3>
			</div>
		</div>
	</div>
</section>
